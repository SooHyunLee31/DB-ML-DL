...
def for_info(choice):
    ...
    if choice == 'Lockheed  Martin Corporation':
        ...
        try:
            ...
            with con:
                col1, col2, col3 = st.columns([1.25,3.5,1.25])
            # 이미지 출력
                with col2:
                    st.image(image_path, caption=f'{choice} 로고', width=400)
    ...
    if choice == 'RTX Corporation':
        ...
        try:
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path1, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path1}")
    ...
    if choice == 'Northrop Grumman Corporation':
        ...
        try:
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path2, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path2}")
    ...
    if choice == 'The Boeing Company':
        ...
        try:
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path3, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path3}")
    ...
    if choice == 'General Dynamics Corporation':
        ...
        st.divider()
        # 이미지 경로
        image_path4 = "image2/제너럴 다이내믹스 .png"
        ...
        try:
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path4, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path4}")
    ...
    if choice == 'BAE Systems': 
        ...
        st.divider()
        # 이미지 경로
        image_path5 = "image2/베이 시스템즈.png"
        ...
        try:
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path5, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path5}")
    ...
    if choice == 'Rostec':
        ...
        try:
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path6, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path6}")
    ...
    if choice == 'AVIC':
        ...
        st.divider()
        # 이미지 경로
        image_path7 = "image2/AVIC.jpg"

        # 이미지 불러오기
        try:
            image = Image.open(image_path7)
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path7, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path7}")
    ...
    if choice == 'NORINCO':
        ...
        st.divider()
        # 이미지 경로
        image_path8 = "image2/노린코.png"

        # 이미지 불러오기
        try:
            image = Image.open(image_path8)
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path8, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path8}")
    ...
    if choice == 'CETC':
        ...
        st.divider()
        # 이미지 경로
        image_path9 = "image2/CETC.png"

        # 이미지 불러오기
        try:
            image = Image.open(image_path9)
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path9, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path9}")
    ...
    if choice == 'L3Harris Technologies':
        ...
        st.divider()
        # 이미지 경로
        image_path10 = "image2/L3.png"

        # 이미지 불러오기
        try:
            image = Image.open(image_path10)
            ...
            # 이미지 출력
                with col2:
                    st.image(image_path10, caption=f'{choice} 로고', width=400)
        except FileNotFoundError:
            st.error(f"이미지를 찾을 수 없습니다: {image_path10}")
